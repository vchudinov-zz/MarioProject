...
public class EvolvingTrainer extends MasterTrainer {
	...
	public EvolvingTrainer(String parameterFileName, String debugParameterFileName, String genomeFileName, 
			String genomeBackupFileName, String lastPopulationInfoFileName, String generationInfoFolder, 
			String winnerFolder, String nameOfExperiment, int maxNumberOfGenerations, 
	...
	public boolean trainNetwork(){
		...
		status = experimentSession(genomeFileName, maxNumberOfGenerations);
	...
	private boolean testVariables(){
		 ...
		 if (maxNumberOfGenerations <= 0) return false;
	 ...
	 * @param generations
	 */
	private boolean experimentSession (String starterGenomeFileName, int generations){
