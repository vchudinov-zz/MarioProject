...
public class AutomatedTC extends Console {

	public AutomatedTC(String nameOfExperiment, int maxNumberOfGenerations,
	...
	public static void main(String[] args) throws IOException {
		...
		AutomatedTC tc = new AutomatedTC(nameOfExperiment, maxNumberOfGenerations, stopOnFirstGoodOrganism, errorThreshold, rootDataFolder);
