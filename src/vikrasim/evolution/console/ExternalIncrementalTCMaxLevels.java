...
public class ExternalIncrementalTCMaxLevels extends Console {
	...
	public ExternalIncrementalTCMaxLevels(String nameOfExperiment,
			int maxNumberOfGenerations, boolean stopOnFirstGoodOrganism,
			double errorThreshold, String rootDataFolder) {
	...
	public static void main(String[] args) throws IOException {
		...
		ExternalIncrementalTCMaxLevels tc = new ExternalIncrementalTCMaxLevels(
	...
	private void train(MasterAgent agent, double winnerPercentageThreshold,
		...
		// ="D:\\Users\\Simon\\Documents\\MarioFun\\NEAT data\\Training data\\Training environment\\Generation Info\\Dif 1 levels 14\\g_000150";
