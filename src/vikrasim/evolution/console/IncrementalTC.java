...
public class IncrementalTC extends Console {
	...
	public static void main(String[] args) throws IOException {
		...
		IncrementalTC tc = new IncrementalTC(nameOfExperiment,
				maxNumberOfGenerations, stopOnFirstGoodOrganism,
	...
	private void train(MasterAgent agent, double winnerPercentageThreshold)
		...
		// Create evaluator
		MasterEvaluator evaluator = new IncrementalEvaluator(levelParameters,
				agent);
