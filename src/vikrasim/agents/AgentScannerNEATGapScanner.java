...
public class AgentScannerNEATGapScanner extends AgentScannerNEAT implements Agent {
	...
	public AgentScannerNEATGapScanner(String agentName, String genomeFileName, int zLevelEnemies, int zLevelScene, 
	...
	public AgentScannerNEATGapScanner(String agentName, Organism brain, int zLevelEnemies, int zLevelScene, 
			int scannerLength, int scannerHeight) {
