...
public class AgentNEAT extends MasterAgent implements Agent {
		
	public AgentNEAT(String agentName, String genomeFileName, int zLevelEnemies, int zLevelScene) {
		super(agentName, genomeFileName, zLevelEnemies, zLevelScene);
		
		create();
	}
	
	public AgentNEAT(String agentName, Organism brain, int zLevelEnemies, int zLevelScene) {
