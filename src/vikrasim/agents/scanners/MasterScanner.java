...
public abstract class  MasterScanner {
	...
	public MasterScanner(int length, int height, Dir scanDirection, ScannerType type){
	...
	protected  abstract void populatelLine(int[][] cellsToScan, int marioX, int marioY);
