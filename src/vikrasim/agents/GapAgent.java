...
public class GapAgent extends MasterAgent implements Agent {
	ArrayList<MasterScanner> scanners;
	int scannerLength;
	int scannerHeight;

	public GapAgent(String agentName, String genomeFileName, int zLevelEnemies,
			int zLevelScene, int scannerLength, int scannerHeight) {
	...
	public GapAgent(String agentName, Organism brain, int zLevelEnemies,
			int zLevelScene, int scannerLength, int scannerHeight) {
