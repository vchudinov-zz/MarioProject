...
public class Judge {
	...
	private void startCompetition() {
		...
		String[] levels = createLevelsToTestOn(numberOfLevels, possibleLevels,
		...
		double[][] resultsSurvival = runCompetitionRound(agentList, levels,
				eval);
	...
	private double[][] runCompetitionRound(Vector<Agent> agentList,
			String[] levels, Evaluator eval) {
